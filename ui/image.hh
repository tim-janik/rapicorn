...
public:
  ...
  virtual void   normal_element      (const String &e) override { update_source (normal_element_, e, "normal_element"); }
  virtual String prelight_element    () const override          { return prelight_element_; }
  virtual void   prelight_element    (const String &e) override { update_source (prelight_element_, e, "prelight_element"); }
  virtual String impressed_element   () const override          { return impressed_element_; }
  virtual void   impressed_element   (const String &e) override { update_source (impressed_element_, e, "impressed_element"); }
  virtual String insensitive_element () const override          { return insensitive_element_; }
  virtual void   insensitive_element (const String &e) override { update_source (insensitive_element_, e, "insensitive_element"); }
  virtual String default_element     () const override          { return default_element_; }
  virtual void   default_element     (const String &e) override { update_source (default_element_, e, "default_element"); }
  virtual String focus_element       () const override          { return focus_element_; }
  virtual void   focus_element       (const String &e) override { update_source (focus_element_, e, "focus_element"); }
};
