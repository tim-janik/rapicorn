...
public:
  ...
  IRect         fill_area       ();     ///< Retrieve fill area of the image, equals width and height if unknown.
  /// Render image into cairo context transformed into @a image_rect, clipped by @a render_rect.
  void          draw_image      (cairo_t *cairo_context, const IRect &render_rect, const IRect &image_rect);
