...
test_poll_consts()
{
  TCMP (PollFD::IN,     ==, POLLIN);
  TCMP (PollFD::PRI,    ==, POLLPRI);
  TCMP (PollFD::OUT,    ==, POLLOUT);
  TCMP (PollFD::RDNORM, ==, POLLRDNORM);
  TCMP (PollFD::RDBAND, ==, POLLRDBAND);
  TCMP (PollFD::WRNORM, ==, POLLWRNORM);
  TCMP (PollFD::WRBAND, ==, POLLWRBAND);
  TCMP (PollFD::ERR,    ==, POLLERR);
  TCMP (PollFD::HUP,    ==, POLLHUP);
  TCMP (PollFD::NVAL,   ==, POLLNVAL);
...
test_dtoi64()
{
  ...
  TCMP (dtoi64 (-0.3), ==, -0);
  TCMP (dtoi64 (+0.7), ==, +1);
  TCMP (dtoi64 (+1.49999999999999), ==, +1);
  TCMP (dtoi64 (+1.5), ==, +2);
  TCMP (dtoi64 (-0.7), ==, -1);
  TCMP (dtoi64 (-1.49999999999999), ==, -1);
  TCMP (dtoi64 (-1.5), ==, -2);
